...
function Computer(name, ramSizeGb, cpuCores, cpuSpeedGhz) {
    ...
    this.printSpecs = function() {
        console.log("This computer is named " + name + ". It has " + ramSizeGb
            + " GB RAM, and a " + cpuCores + "-core, " + cpuSpeedGhz + "GHz processor.");
    }
}
...
function ComputerRewrite(name, ramSizeGb, cpuCores, cpuSpeedGhz) {
    ...
    obj.printSpecs = function() {
        console.log("This computer is named " + this.name + ". It has " + this.ramSizeGb
            + " GB RAM, and a " + this.cpuCores + "-core, " + cpuSpeedGhz + "GHz processor.");
    }
...
// Whenever we want every instance of an object to have
...
ComputerProto.prototype.printSpecs = function() {
    console.log("This computer is named " + this.name + ". It has " + this.ramSizeGb
        + " GB RAM, and a " + this.cpuCores + "-core, " + this.cpuSpeedGhz + "GHz processor.");
}
...
Laptop.prototype.printSpecs() = function() {
    console.log("This laptop is named " + this.name + " and weighs " + weight + "lbs. It has "
        + ramSizeGb + "Gb RAM, and has a " + cpuCores + "-core, " + cpuSpeedGhz + "GHz processor.");
}
